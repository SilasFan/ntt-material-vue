<template>
    <div class="borrow">
        ...
        <br>
        <br>
        <h5 style="color:orange;margin-top:5px;text-align:left">（删除时请在id处填写删除第n个即可）</h5>
        <h4
...
export default {
    ...
    methods: {
        queryItem() {
            if (this.curr_item.count == 0 || this.curr_item.count == null) {
                this.errorDis = true;
                return;
            }
            ...
            fetch("http://localhost:4000/graphql", {
                ...
                res.json().then(data => {
                    if (data.data.goodByID != null) {
                        ...
                        if (
                            this.curr_item.brokenDes != null &&
                            this.curr_item.brokenDes != ""
                        ) {
